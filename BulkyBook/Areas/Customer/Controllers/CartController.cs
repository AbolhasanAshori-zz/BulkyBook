...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPost()
        {
            ...
            ModelState.AddModelError(string.Empty, "Verification email send. Please check your email");
        ...
        public IActionResult Plus(int cartId)
        {
            var cart = _unitOfWork.ShoppingCart.GetFirstOrDefault
                            (sc => sc.Id == cartId, includeProperties: "Product");
            cart.Count += 1;
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count == 1)
            {
                var cnt = _unitOfWork.ShoppingCart.GetAll(sc => sc.ApplicationUserId == cart.ApplicationUserId)
                            .ToList().Count;
                _unitOfWork.ShoppingCart.Remove(cart);
                _unitOfWork.Save();
                HttpContext.Session.SetInt32(SD.ssShoppringCart, cnt - 1);
            }
            else
            {
                cart.Count -= 1;
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            _unitOfWork.Save();
            HttpContext.Session.SetInt32(SD.ssShoppringCart, 0);
